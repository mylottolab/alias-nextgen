...
AL.STR = {
  ...
  /* 🔴 2026-09-20 신설 — 관리자 이용권 지급 */
  adTitle:   { kr:'이용권 주기', en:'Grant a plan' },
  adSub:     { kr:'테스터나 시험 계정에 돈을 안 받고 이용권을 드립니다.',
               en:'Give a plan to testers without payment.' },
  adWarn:    { kr:'⚠ 누구에게 얼마를 왜 줬는지 모두 기록에 남습니다. 아래에서 보실 수 있습니다.',
               en:'⚠ Every grant is logged — who, how long, and why. See below.' },
  adFindPh:  { kr:'닉네임 앞부분', en:'Start of the nickname' },
  adFind:    { kr:'찾기', en:'Find' },
  adSearching:{ kr:'찾는 중…', en:'Searching…' },
  adNone:    { kr:'그런 분이 없습니다.', en:'No one found.' },
  adJoined:  { kr:'{when} 가입', en:'Joined {when}' },
  adAliases: { kr:'별칭 {n}개', en:'{n} aliases' },
  adPaid:    { kr:'이용권', en:'Plan until' },
  adTrial:   { kr:'체험', en:'Trial until' },
  adLeft:    { kr:'{n}일 남음', en:'{n} days left' },
  adOver:    { kr:'끝남', en:'ended' },
  adGive:    { kr:'{n}개월', en:'{n} mo' },
  adAsk:     { kr:'{who}님께 {n}개월을 드릴까요?\n\n돈을 안 받고 주는 것이며 기록에 남습니다.',
               en:'Give {who} {n} months?\n\nThis is free of charge and will be logged.' },
  adWhy:     { kr:'왜 드리는지 적어주세요. (기록에 남습니다)',
               en:'Why? (this is logged)' },
  adWhyDefault:{ kr:'테스터', en:'Tester' },
  adDone:    { kr:'{who}님께 {n}개월을 드렸습니다. 이제 {when} 까지입니다.',
               en:'Gave {who} {n} months. Now valid until {when}.' },
  adLog:     { kr:'준 기록', en:'Grant log' },
  adLogNone: { kr:'아직 없습니다.', en:'Nothing yet.' },
  adNotAdmin:{ kr:'관리자만 볼 수 있는 화면입니다.', en:'Admins only.' },
  adMenu:    { kr:'이용권 주기 (관리자)', en:'Grant a plan (admin)' },

  /* 🔴 2026-09-19 — 또렷하게 읽히는 색 셋 */
  thCrisp:   { kr:'또렷', en:'Crisp' },
  thCream:   { kr:'크림', en:'Cream' },
  thSlate:   { kr:'진회', en:'Slate' },

  /* 글씨 크기·굵기 */
  fsTitle:   { kr:'글씨 크기', en:'Text size' },
  fsMd:      { kr:'보통', en:'Normal' },
  fsLg:      { kr:'크게', en:'Large' },
  fsXl:      { kr:'아주 크게', en:'Extra large' },
  fwTitle:   { kr:'글씨 굵기', en:'Text weight' },
  fwNormal:  { kr:'보통', en:'Normal' },
  ...
  rcOnVid:    { kr:'🔴 녹화 중 · {n}일 뒤 지워집니다 · 최대 14분',
                en:'🔴 Recording video · deleted after {n} days · up to 14 min' },
  rcFull:     { kr:'녹화가 한도에 닿아 저장했습니다. (약 14분)',
                en:'Reached the size limit and saved. (about 14 min)' },
  rcAskVid:   { kr:'이 영상통화를 녹화합니다', en:'Record this video call' },
  rcAskVidN:  { kr:'상대 얼굴과 두 분의 목소리가 담깁니다. 한 번에 14분까지 담깁니다.',
                en:'Their video and both voices are captured, up to 14 minutes.' },
  rcGotVid:   { kr:'{who}님이 이 영상통화를 녹화하려고 합니다.\n{n}일 동안 보관됩니다.',
                en:'{who} wants to record this video call.\nIt would be kept for {n} days.' },
  rcGotV1:    { kr:'상대 얼굴과 두 분의 목소리가 담깁니다',
                en:'Their video and both voices are captured' },
  rcPlayVid:  { kr:'🔴 녹화 보기', en:'🔴 Play video' },
  ...
  rcDownStarted:{ kr:'받는 중입니다. 다 받으면 알림이 뜨고, 폰의 다운로드 폴더에 들어갑니다.',
...
AL.applyTheme = function(t){
  ...
  /* 🔴 2026-09-19 — 글씨 크기와 굵기.
     ⚠ "주간 바탕이 연해서 안 읽힌다" 는 말씀에서 시작했는데, 색보다
...
AL.THEME_OPTS = {
  ...
  /* 🔴 2026-09-19 — 또렷하게 읽히는 셋을 **맨 앞**에 둡니다.
     "고를 만한 색이 없다" 는 말씀은 대개 뒤쪽까지 안 보셔서 나옵니다.
     잘 읽히는 것이 먼저 보여야 합니다. */
...
AL.STORE_SKUS = {
  /* ⚠ 2026-09-27 — 3개월 상품을 실수로 지웠습니다. 구글은 한 번 쓴
     상품 번호를 **다시 쓰지 못하게** 합니다. 그래서 뒤에 _a 를 붙여
     새로 만들었습니다. 세 곳(여기·BillingBridge.java·서버 함수)이
     모두 같아야 합니다. */
  3:  'burum_plan_3m_a',
  6:  'burum_plan_6m',
  12: 'burum_plan_12m',
